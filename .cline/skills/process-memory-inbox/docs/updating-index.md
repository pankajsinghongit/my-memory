...
**When to update**: After creating new files or folders during inbox processing
...
**CRITICAL**: When you create new files or folders during inbox processing:
...
- ✅ Create a new file
- ✅ Create a new folder
- ✅ Reorganize files (moving/renaming)
- ✅ Delete files or folders

Don't update if you're only:
- ❌ Adding content to existing files (no structural changes)
- ❌ Updating file metadata
- ❌ Archiving processed items

---

**Remember**: The index is your navigation hub. Always read it thoroughly first, then update everything that needs to change to keep it accurate and complete.